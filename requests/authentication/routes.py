# /requests/authentication/routes.py

from fastapi import APIRouter, Request, HTTPException, status, Query, Depends
from typing import Optional

from models.user import User
from models.request_models import UserLoginRequest, SocialLoginRequest, UserRegistrationRequest, ForgotPasswordRequest, ResetPasswordRequest, TwoFactorVerifyRequest
from models.response_models import LoginResponse, ErrorResponse, UserRegistrationResponse, EmailVerificationResponse, OAuthProvidersResponse, OAuthAuthorizationResponse, HealthResponse, TwoFactorSetupResponse, GeneralResponse
