...
from services.repositories.question_repository import QuestionRepository
from services.repositories.answer_repository import AnswerRepository
...
class IntelligentQAService:
    ...
    1. Cache Check (Redis) → 2. Semantic Search (Qdrant) → 3. Quality Evaluation → 4. Gemini API → 5. Storage
    """
    ...
    async def initialize_system(self) -> Dict[str, Any]:
        """
        Initialize the complete Q&A system including knowledge base loading.
        This should be called during application startup.
        """
        logger.info("🚀 Initializing Syria GPT Q&A system...")
        ...
        try:
            ...
            if init_result.get("status") == "success":
                ...
                logger.info("✅ Syria GPT Q&A system initialized successfully")
            else:
    ...
    async def process_question(
        ...
        try:
            # Step 0: Ensure system is initialized
    ...
    async def get_system_health(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "knowledge_base": {
                ...
                "stats": await data_integration_service.get_knowledge_base_stats() if self._initialized else None
            }
        }
    
    async def reload_knowledge_base(self) -> Dict[str, Any]:
        """Reload the entire knowledge base from data files"""
        logger.info("🔄 Reloading knowledge base...")
        
        try:
            result = await data_integration_service.reload_knowledge_base()
